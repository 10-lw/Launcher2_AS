...
public final class Launcher extends Activity
    ...
    private static void readConfiguration(Context context, LocaleConfiguration configuration) {
        ...
        try {
            ...
            configuration.mcc = in.readInt();//移动国家编号
            configuration.mnc = in.readInt();//移动网号
    ...
    protected void onResume() {
        ...
        //需判断用户是从哪里打开的3td app，是从workspace还是hotseat中间的app btn中
        ...
        InstallShortcutReceiver.flushInstallQueue(this);//最终回调到launchermodel中
    ...
    @Override
    public Object onRetainNonConfigurationInstance() {//此方法等同于onSaveInstanceState
    ...
    */
	...
	/*当接收到屏幕关闭通知时，如果当前launcher在all app页面，那么就回退到workspace页面中*/
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_SCREEN_OFF.equals(action)) {
                ...
                getModel().forceReload();//终会调用mModel的startLoader方法
            }
        }
    };
     ...
     *Launcher被点击时调用，通过取出tag获取到对应view标识的info，然后来启动对应App的Activity
